...
#ifndef _PLATFORM_YAAB_DOTNET_SELECTOR_H_
#define _PLATFORM_YAAB_DOTNET_SELECTOR_H_ 1
...
#if defined(PLATFORM_ARM_YAAB_DOTNET)
#define HAL_SYSTEM_NAME                   "YAAB_DOTNET"
...
#define DRIVER_PAL_BUTTON_MAPPING                                           \
    { LPC22XX_GPIO::c_P1_21, BUTTON_B0 }, /* Upper Left    - Backlight (spare n)   RP */ \
    ...
    { LPC22XX_GPIO::c_P1_20   , BUTTON_B4 }, /* Middle Right  - Enter                    */ \
...
#define YAAB_DOTNET_SOCKETS_ENABLED               0

#if defined(YAAB_DOTNET_SOCKETS_ENABLED)
...
#endif //defined(YAAB_DOTNET_SOCKETS_ENABLED)
...
#endif // PLATFORM_ARM_YAAB_DOTNET
//
// drivers
/////////////////////////////////////////////////////////

#endif // _PLATFORM_YAAB_DOTNET_SELECTOR_H_
