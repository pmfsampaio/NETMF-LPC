...
extern BlockStorageDevice g_AT49BV642DT_16_BS;

FileSystemVolume g_plak1a_LPC2478_FS;

void FS_AddVolumes()
{
    FileSystemVolumeList::AddVolume( &g_plak1a_LPC2478_FS, "ROOT", 0, 0, &g_FAT32_STREAM_DriverInterface, &g_FAT32_FILE_SYSTEM_DriverInterface, &g_AT49BV642DT_16_BS, 0, FALSE );
}
