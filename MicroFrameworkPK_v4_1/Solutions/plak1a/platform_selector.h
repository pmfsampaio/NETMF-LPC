...
#ifndef _PLATFORM_plak1a_SELECTOR_H_
#define _PLATFORM_plak1a_SELECTOR_H_ 1
...
#if defined(PLATFORM_ARM_plak1a)
#define HAL_SYSTEM_NAME                   "plak1a"
...
#define SYSTEM_CLOCK_HZ                 14745600
#define SYSTEM_CYCLE_CLOCK_HZ           58982400 // CCLK = 60MHz
#define CLOCK_COMMON_FACTOR              1000000
#define SLOW_CLOCKS_PER_SECOND          14745600
...
#define DRIVER_PAL_BUTTON_MAPPING                                           \
    ...
    { LPC22XX_GPIO::c_P1_24   , BUTTON_B4 }, /* Middle Right  - Enter                    */ \
...
#define plak1a_SOCKETS_ENABLED               0

#if defined(plak1a_SOCKETS_ENABLED)

#define NETWORK_MEMORY_PROFILE__medium       0

#include <pal\net\Network_Defines.h>

#define NETWORK_INTERFACE_COUNT              0

#define NETWORK_USE_LOOPBACK                 1
#define NETWORK_USE_DHCP                     1

#endif //defined(plak1a_SOCKETS_ENABLED)
...
#endif // PLATFORM_ARM_plak1a
//
// drivers
/////////////////////////////////////////////////////////

#endif // _PLATFORM_plak1a_SELECTOR_H_
