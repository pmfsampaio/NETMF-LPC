...
extern BlockStorageDevice g_AM29LV800BT_16_BS;

FileSystemVolume g_plak1a_FS;

void FS_AddVolumes()
{
    FileSystemVolumeList::AddVolume( &g_plak1a_FS, "ROOT", 0, 0, &g_FAT32_STREAM_DriverInterface, &g_FAT32_FILE_SYSTEM_DriverInterface, &g_AM29LV800BT_16_BS, 0, FALSE );
}
