...
//static SPI_TypeDef* g_LPC178X_Spi[] = {SPI1, SPI2, SPI3}; // IO addresses
...
#if 0
    SPI_TypeDef* spi = g_LPC178X_Spi[Configuration.SPI_mod];
...
BOOL CPU_SPI_Xaction_nWrite16_nRead16( SPI_XACTION_16& Transaction )
{
    NATIVE_PROFILE_HAL_PROCESSOR_SPI();
#if 0
    SPI_TypeDef* spi = g_LPC178X_Spi[Transaction.SPI_mod];
