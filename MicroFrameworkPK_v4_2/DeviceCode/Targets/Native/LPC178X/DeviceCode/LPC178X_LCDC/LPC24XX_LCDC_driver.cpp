...
*/
	...
	tmp = CLCDC_LCDCTRL_BPP24;//CLCDC_LCDCTRL_BPP16_565_MODE;
	...
	//Set divider 0
	LPC24XX::SYSCON().LCD_CFG = 72000000/3000000;//0;
...
//    LPC24XX::PCB().PINSEL10 = 0x0;
    LPC24XX::PCB().PINSEL11 = TFT_24_888;
...
//    CPU_GPIO_DisablePin( LPC24XX_LCDC::c_LCD_LE, RESISTOR_DISABLED, GPIO_ATTRIBUTE_NONE, GPIO_ALT_MODE_3 );
    ...
    CPU_GPIO_DisablePin( LPC24XX_LCDC::c_LCD_VD_3, RESISTOR_DISABLED, GPIO_ATTRIBUTE_NONE, GPIO_ALT_MODE_2 );
    CPU_GPIO_DisablePin( LPC24XX_LCDC::c_LCD_VD_2, RESISTOR_DISABLED, GPIO_ATTRIBUTE_NONE, GPIO_ALT_MODE_2 );
//    CPU_GPIO_DisablePin( LPC24XX_LCDC::c_LCD_VD_1, RESISTOR_DISABLED, GPIO_ATTRIBUTE_NONE, GPIO_ALT_MODE_1 );
//    CPU_GPIO_DisablePin( LPC24XX_LCDC::c_LCD_VD_0, RESISTOR_DISABLED, GPIO_ATTRIBUTE_NONE, GPIO_ALT_MODE_1 );
...
//    CPU_GPIO_DisablePin( LPC24XX_LCDC::c_LCD_VD_9, RESISTOR_DISABLED, GPIO_ATTRIBUTE_NONE, GPIO_ALT_MODE_1 );
//    CPU_GPIO_DisablePin( LPC24XX_LCDC::c_LCD_VD_8, RESISTOR_DISABLED, GPIO_ATTRIBUTE_NONE, GPIO_ALT_MODE_1 );
    ...
    CPU_GPIO_DisablePin( LPC24XX_LCDC::c_LCD_VD_18, RESISTOR_DISABLED, GPIO_ATTRIBUTE_NONE, GPIO_ALT_MODE_1 );
//    CPU_GPIO_DisablePin( LPC24XX_LCDC::c_LCD_VD_17, RESISTOR_DISABLED, GPIO_ATTRIBUTE_NONE, GPIO_ALT_MODE_1 );
//    CPU_GPIO_DisablePin( LPC24XX_LCDC::c_LCD_VD_16, RESISTOR_DISABLED, GPIO_ATTRIBUTE_NONE, GPIO_ALT_MODE_1 );
}
