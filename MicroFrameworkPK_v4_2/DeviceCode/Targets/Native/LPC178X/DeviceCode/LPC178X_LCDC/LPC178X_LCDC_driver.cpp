...
BOOL LPC178X_LCDC_Driver::Initialize(DISPLAY_CONTROLLER_CONFIG& config)
{
	...
	ConnectPins(config.BitsPerPixel);
...
*/
	...
	tmp = CLCDC_LCDCTRL_BPP24;//CLCDC_LCDCTRL_BPP16;//CLCDC_LCDCTRL_BPP16_565_MODE;
...
void LPC178X_LCDC_Driver::ConnectPins (UINT8 bitsPerPixel)
{
    ...
    if (bitsPerPixel == 32){
        CPU_GPIO_DisablePin( LPC178X_LCDC::c_LCD_FP, RESISTOR_DISABLED, GPIO_ATTRIBUTE_NONE, GPIO_ALT_MODE_7 );
        CPU_GPIO_DisablePin( LPC178X_LCDC::c_LCD_LP, RESISTOR_DISABLED, GPIO_ATTRIBUTE_NONE, GPIO_ALT_MODE_7 );

        CPU_GPIO_DisablePin( LPC178X_LCDC::c_LCD_VD_1, RESISTOR_DISABLED, GPIO_ATTRIBUTE_NONE, GPIO_ALT_MODE_7 );
        CPU_GPIO_DisablePin( LPC178X_LCDC::c_LCD_VD_0, RESISTOR_DISABLED, GPIO_ATTRIBUTE_NONE, GPIO_ALT_MODE_7 );

        CPU_GPIO_DisablePin( LPC178X_LCDC::c_LCD_VD_9, RESISTOR_DISABLED, GPIO_ATTRIBUTE_NONE, GPIO_ALT_MODE_7 );
        CPU_GPIO_DisablePin( LPC178X_LCDC::c_LCD_VD_8, RESISTOR_DISABLED, GPIO_ATTRIBUTE_NONE, GPIO_ALT_MODE_7 );

        CPU_GPIO_DisablePin( LPC178X_LCDC::c_LCD_VD_17, RESISTOR_DISABLED, GPIO_ATTRIBUTE_NONE, GPIO_ALT_MODE_7 );
        CPU_GPIO_DisablePin( LPC178X_LCDC::c_LCD_VD_16, RESISTOR_DISABLED, GPIO_ATTRIBUTE_NONE, GPIO_ALT_MODE_7 );

        CPU_GPIO_DisablePin(LPC178X_GPIO::c_P0_16, RESISTOR_DISABLED, GPIO_ATTRIBUTE_NONE, GPIO_ALT_PRIMARY);
    }
}
