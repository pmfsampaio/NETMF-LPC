...
#ifndef _LPC178X_LCDC_H_
#define _LPC178X_LCDC_H_ 1
...
struct LPC178X_LCDC
{
    static const UINT32 c_LCDC_Base     = LPC_LCD_BASE;

    // LCD pins
//    static const UINT32 c_LCD_PWR  = LPC178X_GPIO::c_P2_00;
//    static const UINT32 c_LCD_LE   = LPC178X_GPIO::c_P2_01;
    static const UINT32 c_LCD_DCLK = LPC178X_GPIO::c_P2_02;
    static const UINT32 c_LCD_FP   = LPC178X_GPIO::c_P2_03;
    static const UINT32 c_LCD_ENAB = LPC178X_GPIO::c_P2_04;
    static const UINT32 c_LCD_LP   = LPC178X_GPIO::c_P2_05;

    // Assignment for TFT
    static const UINT32 c_LCD_VD_7  = LPC178X_GPIO::c_P2_09; // Red 7
    static const UINT32 c_LCD_VD_6  = LPC178X_GPIO::c_P2_08; // Red 6
    static const UINT32 c_LCD_VD_5  = LPC178X_GPIO::c_P2_07; // Red 5
    static const UINT32 c_LCD_VD_4  = LPC178X_GPIO::c_P2_06; // Red 4
    static const UINT32 c_LCD_VD_3  = LPC178X_GPIO::c_P4_29; // Red 3
    static const UINT32 c_LCD_VD_2  = LPC178X_GPIO::c_P4_28; // Red 2

    static const UINT32 c_LCD_VD_1  = LPC178X_GPIO::c_P0_05; // Red 1
    static const UINT32 c_LCD_VD_0  = LPC178X_GPIO::c_P0_04; // Red 0

    static const UINT32 c_LCD_VD_15 = LPC178X_GPIO::c_P1_25; // Green 7
    static const UINT32 c_LCD_VD_14 = LPC178X_GPIO::c_P1_24; // Green 6
    static const UINT32 c_LCD_VD_13 = LPC178X_GPIO::c_P1_23; // Green 5
    static const UINT32 c_LCD_VD_12 = LPC178X_GPIO::c_P1_22; // Green 4
    static const UINT32 c_LCD_VD_11 = LPC178X_GPIO::c_P1_21; // Green 3
    static const UINT32 c_LCD_VD_10 = LPC178X_GPIO::c_P1_20; // Green 2

    static const UINT32 c_LCD_VD_9 = LPC178X_GPIO::c_P0_07; // Green 1
    static const UINT32 c_LCD_VD_8 = LPC178X_GPIO::c_P0_06; // Green 0

    static const UINT32 c_LCD_VD_23 = LPC178X_GPIO::c_P1_29; // Blue 7
    static const UINT32 c_LCD_VD_22 = LPC178X_GPIO::c_P1_28; // Blue 6
    static const UINT32 c_LCD_VD_21 = LPC178X_GPIO::c_P1_27; // Blue 5
    static const UINT32 c_LCD_VD_20 = LPC178X_GPIO::c_P1_26; // Blue 4
    static const UINT32 c_LCD_VD_19 = LPC178X_GPIO::c_P2_13; // Blue 3
    static const UINT32 c_LCD_VD_18 = LPC178X_GPIO::c_P2_12; // Blue 2

    static const UINT32 c_LCD_VD_17 = LPC178X_GPIO::c_P0_09; // Blue 1
    static const UINT32 c_LCD_VD_16 = LPC178X_GPIO::c_P0_08; // Blue 0
...
struct LPC178X_LCDC_Driver
{
    ...
    static void ConnectPins (UINT8 bitsPerPixel);
};
