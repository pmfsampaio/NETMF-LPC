...
#define LPC178X_PWM_CHANNELS 4 // number of channels
#define LPC178X_PWM_FIRST_PIN 0 // channel 0 pin (A0)
...
{
    if (channel >= LPC178X_PWM_CHANNELS) return FALSE;
#if 0
...
{
    return LPC178X_PWM_CHANNELS;
}

GPIO_PIN PWM_GetPinForChannel( PWM_CHANNEL channel )
{
    return LPC178X_PWM_FIRST_PIN + channel;
}
