...
#include "../CMSIS/include/lpc177x_8x_i2c.h"
#include "../CMSIS/include/lpc177x_8x_clkpwr.h"

///////////////////////////////////////////////////////////////////////////////

#if defined(ADS_LINKER_BUG__NOT_ALL_UNUSED_VARIABLES_ARE_REMOVED)
#pragma arm section zidata = "g_LPC178X_I2C_Driver"
#endif

LPC178X_I2C_Driver g_LPC178X_I2C_Driver;
...
{
    return LPC178X_I2C_Driver::Initialize();
}

BOOL I2C_Internal_Uninitialize()
{
    return LPC178X_I2C_Driver::Uninitialize();
}

void I2C_Internal_XActionStart( I2C_HAL_XACTION* xAction, bool repeatedStart )
{
    LPC178X_I2C_Driver::MasterXAction_Start( xAction, repeatedStart );
}

void I2C_Internal_XActionStop()
{
    LPC178X_I2C_Driver::MasterXAction_Stop();
}

void  I2C_Internal_GetClockRate( UINT32 rateKhz, UINT8& clockRate, UINT8& clockRate2)
{
    clockRate = LPC178X_I2C_Driver::GetClockRate( rateKhz);
    //clockrate2 not use.
    clockRate2 = 0;    
}
...
{
    return LPC178X_I2C_Driver::GetPins( scl, sda);
}
...
void LPC178X_I2C_Driver::MasterXAction_Start( I2C_HAL_XACTION* xAction, bool repeatedStart )
{
    LPC178X_I2C& I2C = LPC178X::I2C();
    
    g_LPC178X_I2C_Driver.m_currentXAction     = xAction;
    g_LPC178X_I2C_Driver.m_currentXActionUnit = xAction->m_xActionUnits[ xAction->m_current ]; ++xAction->m_current;
    
    if(!repeatedStart)
    {        
        /////////////////////////////////
        // Start sequence
        I2C.I2SCLH = 26;//xAction->m_clockRate ;
        I2C.I2SCLL = 25;//xAction->m_clockRate ;

        I2C.I2CONSET = LPC178X_I2C::STA;
...
void LPC178X_I2C_Driver::MasterXAction_Stop()
{
    LPC178X_I2C& I2C = LPC178X::I2C();
    ...
    I2C.I2CONCLR = LPC178X_I2C::AA | LPC178X_I2C::SI | LPC178X_I2C::STA;
    
    g_LPC178X_I2C_Driver.m_currentXAction     = NULL;
    g_LPC178X_I2C_Driver.m_currentXActionUnit = NULL;
}

UINT8 LPC178X_I2C_Driver::GetClockRate( UINT32 rateKhz )
{
    UINT32 divider = LPC178X_I2C::c_I2C_Clk_KHz / ( 2 * rateKhz );
   
    return (UINT8) divider;
}

void LPC178X_I2C_Driver::WriteToSubordinate( I2C_HAL_XACTION_UNIT* unit )
{
    UINT8* queueData;
...
void LPC178X_I2C_Driver::ReadFromSubordinate( I2C_HAL_XACTION_UNIT* unit )
{
    UINT8* queueData;
...
void  LPC178X_I2C_Driver::GetPins(GPIO_PIN& scl, GPIO_PIN& sda)
{
    scl = LPC178X_I2C::c_I2C_SCL;
    sda = LPC178X_I2C::c_I2C_SDA;
}
