...
void LPC178X_I2C_ER_Interrupt (void* param) // Error Interrupt Handler
{
#if 0
	INTERRUPT_START
...
void LPC178X_I2C_EV_Interrupt (void* param) // Event Interrupt Handler
{
#if 0
	INTERRUPT_START
...
BOOL I2C_Internal_Initialize()
{
    ...
    if (!(RCC->APB1ENR & RCC_APB1ENR_I2CxEN)) { // only once
        ...
        CPU_INTC_ActivateInterrupt(I2Cx_EV_IRQn, LPC178X_I2C_EV_Interrupt, 0);
        CPU_INTC_ActivateInterrupt(I2Cx_ER_IRQn, LPC178X_I2C_ER_Interrupt, 0);
    }
#endif
    return TRUE;
}
