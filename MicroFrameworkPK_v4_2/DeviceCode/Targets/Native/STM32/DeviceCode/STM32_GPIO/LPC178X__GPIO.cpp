...
#if 0
    if(!CPU_INTC_ActivateInterrupt( LPC178X_VIC::c_IRQ_INDEX_EINT3, GPIO_ISR, NULL )) return FALSE;
#endif
    return TRUE;
}
...
//    LPC178X_PCB& PCB = LPC178X::PCB();
    ...
    PINSEL_ConfigPin(PCBReg, PCBRegBit, AltFunction);
