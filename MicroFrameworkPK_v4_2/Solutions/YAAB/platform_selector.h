...
#ifndef _PLATFORM_YAAB_SELECTOR_H_
#define _PLATFORM_YAAB_SELECTOR_H_ 1
...
#if defined(PLATFORM_ARM_YAAB)
#define HAL_SYSTEM_NAME                   "YAAB"
...
#define LPC22XX_UART_PCLK               SYSTEM_CLOCK_HZ
...
#define DRIVER_PAL_BUTTON_MAPPING                                           \
    { LPC22XX_GPIO::c_Pin_None, BUTTON_B0 }, /* c_P1_21 Upper Left    - Backlight (spare n)   RP */ \
    ...
    { LPC22XX_GPIO::c_P0_15   , BUTTON_B4 }, /* c_P1_20 Middle Right  - Enter                    */ \
...
#define YAAB_SOCKETS_ENABLED               1

#if defined(YAAB_SOCKETS_ENABLED)
...
#endif //defined(YAAB_SOCKETS_ENABLED)
...
#endif // PLATFORM_ARM_YAAB
//
// drivers
/////////////////////////////////////////////////////////

#endif // _PLATFORM_YAAB_SELECTOR_H_
